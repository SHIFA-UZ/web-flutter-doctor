...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'clinicWorkspaceAnalytics': 'Analytics',
      ...
      'clinicPlaceholderAnalytics':
          'Clinic analytics (utilization, no-shows, revenue) will appear here in a future release.',
      ...
      'clinicServicesEmpty': 'No catalog items yet. Admins can add services under treatment catalog.',
    ...
    'uz': {
      ...
      'clinicWorkspaceAnalytics': 'Analitika',
      ...
      'clinicPlaceholderAnalytics':
          'Klinika analitikasi (yuklama, qatnashmaslik daraja) keyingi versiyada shu yerda bo\'ladi.',
      ...
      'clinicServicesEmpty': 'Hali katalog yo\'q. Administratorlar xizmatlarni qo\'shishi mumkin.',
    ...
    'ru': {
      ...
      'clinicWorkspaceAnalytics': 'Аналитика',
      ...
      'clinicPlaceholderAnalytics':
          'Аналитика клиники (загрузка, неявки, выручка) появится здесь в следующих версиях.',
      ...
      'clinicServicesEmpty': 'Каталог пуст. Администраторы могут добавить услуги в каталоге планов лечения.',
      'clinicSettingsReadOnly':
