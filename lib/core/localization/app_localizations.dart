...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'dismiss': 'Dismiss',
      'more': 'More',
      'calendarTimezoneMismatchHint':
          'Your current device timezone does not match the calendar schedule timezone ({scheduleTimeZone}). '
      ...
      'calendarStaffCalendars': 'Staff calendars',
      'calendarDayViewCount': 'Days shown in grid',
      'calendarOccupancyLegend':
          'Dark = fully booked · No fill = open availability',
      'unsavedChangesMessage':
          'You have unsaved changes. Discard them?',
      'pleaseChoosePlace': 'Please choose a place',
      'noSummaryYet': 'No saved appointment documentation found.',
      'copied': 'Copied',
      'noPrescriptions': 'No prescriptions yet',
      'refreshing': 'Refreshing...',
      'selectPatientHint': 'Select a patient to view details',
      'filterConversations': 'Filter conversations',
      'cannotOpenLink': 'Cannot open link',
      'setUpClinicWorkspace':
          'Set up a clinic workspace to create treatment plans.',
      'searchPatientsAppointmentsHint': 'Search patients, appointments…',
      'confirmed': 'Confirmed',
      ...
      'hideAiReminders': 'Hide reminders',
      'showAiReminders': 'Show reminders ({count})',
      'holdToExpandAnswer': 'Hold to expand answer',
      'holdToCollapseAnswer': 'Hold to collapse answer',
      ...
      'clinicFinanceExport': 'Export',
      'clinicFinanceExportCsv': 'Export CSV',
      'clinicFinanceExportPdf': 'Export PDF',
      'clinicFinanceExportFailed': 'Export failed',
      'clinicFinanceExportNoRows': 'Nothing to export for the current filters.',
      'clinicFinanceLoadMore': 'Load more',
      'clinicFinanceShowingRows': 'Showing {{shown}} of {{total}}',
      'clinicFinanceTotalRevenueHint': 'Collected revenue across billable visits',
      'clinicFinanceInstallTotalsFilteredNote': 'Totals reflect the current filters.',
      'clinicTreatmentPlanDetailTitle': 'Treatment plan',
      'clinicTreatmentPlanDetailNotFound': 'Treatment plan not found.',
      'clinicTreatmentPlanDetailDentalChart': 'Dental chart',
      'clinicTreatmentPlanLineStatus': 'Line status',
      'clinicTreatmentPlanLineStatusPlanned': 'Planned',
      'clinicTreatmentPlanLineStatusScheduled': 'Scheduled',
      'clinicTreatmentPlansVisits': 'Visits',
      'clinicTreatmentPlansVisitsLoading': 'Loading visits…',
      'clinicTreatmentPlansNoVisits': 'No visits linked to this plan yet.',
      'clinicTreatmentPlansNoVisitsShort': 'No visits',
      'clinicTreatmentPlansOpenVisit': 'Open visit',
      'clinicTreatmentPlansVisitCancelled': 'Cancelled',
      'clinicTreatmentPlansVisitCancelledOpen': 'This visit was cancelled.',
      'clinicTreatmentPlansVisitCount': '{{count}} visits',
      'clinicTreatmentPlansVisitLabel': 'Visit',
      'clinicTreatmentPlansVisitPast': 'Past',
      'clinicTreatmentPlansVisitUpcoming': 'Upcoming',
      'clinicChangeStatus': 'Change status',
      ...
      'notificationTypeAppointmentRescheduled': 'Appointment rescheduled',
      'notificationTypeAppointmentPaid': 'Payment received',
      'notificationTypePartnershipInvite': 'Therapy partner invite',
      'notificationTypePartnershipAccepted': 'Partner accepted',
      'notificationTypePartnershipProgress': 'Partnership update',
      'notificationTypeChatMessage': 'New message',
      ...
      'inviteSentWaiting':
          'Invite sent. Waiting for {name} to accept.',
      'inviteReceivedFrom':
          '{name} invited you to co-treat this patient.',
      'cancelPartnerInvite': 'Cancel invite',
      'partnershipRoleSender': 'You sent',
      'partnershipRoleInvitee': 'Invite for you',
    ...
    'uz': {
      ...
      'clinicFinanceExport': 'Eksport',
      'clinicFinanceExportCsv': 'CSV eksport',
      'clinicFinanceExportPdf': 'PDF eksport',
      'clinicFinanceExportFailed': 'Eksport muvaffaqiyatsiz',
      'clinicFinanceExportNoRows': 'Joriy filtrlar bo\'yicha eksport qilinadigan ma\'lumot yo\'q.',
      'clinicFinanceLoadMore': 'Yana yuklash',
      'clinicFinanceShowingRows': '{{shown}} / {{total}} ko\'rsatilmoqda',
      'clinicFinanceTotalRevenueHint': 'To\'lovli tashriflar bo\'yicha yig\'ilgan daromad',
      'clinicFinanceInstallTotalsFilteredNote': 'Jami summalar joriy filtrlarga mos.',
      'clinicTreatmentPlanDetailTitle': 'Davolash rejasi',
      'clinicTreatmentPlanDetailNotFound': 'Davolash rejasi topilmadi.',
      'clinicTreatmentPlanDetailDentalChart': 'Tish sxemasi',
      'clinicTreatmentPlanLineStatus': 'Qator holati',
      'clinicTreatmentPlanLineStatusPlanned': 'Rejalashtirilgan',
      'clinicTreatmentPlanLineStatusScheduled': 'Belgilangan',
      'clinicTreatmentPlansVisits': 'Tashriflar',
      'clinicTreatmentPlansVisitsLoading': 'Tashriflar yuklanmoqda…',
      'clinicTreatmentPlansNoVisits': 'Bu rejaga bog\'langan tashriflar yo\'q.',
      'clinicTreatmentPlansNoVisitsShort': 'Tashrif yo\'q',
      'clinicTreatmentPlansOpenVisit': 'Tashrifni ochish',
      'clinicTreatmentPlansVisitCancelled': 'Bekor qilingan',
      'clinicTreatmentPlansVisitCancelledOpen': 'Bu tashrif bekor qilingan.',
      'clinicTreatmentPlansVisitCount': '{{count}} ta tashrif',
      'clinicTreatmentPlansVisitLabel': 'Tashrif',
      'clinicTreatmentPlansVisitPast': 'O\'tgan',
      'clinicTreatmentPlansVisitUpcoming': 'Kelgusi',
      'clinicChangeStatus': 'Holatni o\'zgartirish',
      ...
      'notificationTypeAppointmentRescheduled': 'Uchrashuv vaqti o\'zgartirildi',
      'notificationTypeAppointmentPaid': 'To\'lov qabul qilindi',
      'notificationTypePartnershipInvite': 'Hamkorlik taklifi',
      'notificationTypePartnershipAccepted': 'Hamkor qabul qildi',
      'notificationTypePartnershipProgress': 'Hamkorlik yangilanishi',
      'notificationTypeChatMessage': 'Yangi xabar',
      ...
      'inviteSentWaiting':
          'Taklif yuborildi. {name} qabul qilishini kutmoqda.',
      'inviteReceivedFrom':
          '{name} sizni ushbu bemorni birga davolashga taklif qildi.',
      'cancelPartnerInvite': 'Taklifni bekor qilish',
      'partnershipRoleSender': 'Siz yubordingiz',
      'partnershipRoleInvitee': 'Sizga taklif',
      'patientBriefingGenerating':
      ...
      'more': 'Yana',
      'calendarTimezoneMismatchHint':
          'Joriy qurilma vaqt zonasi kalendar jadvali vaqt zonasi ({scheduleTimeZone}) bilan mos emas. '
      ...
      'calendarStaffCalendars': 'Xodimlar taqvimi',
      'calendarDayViewCount': 'Jadvalda ko\'rsatiladigan kunlar',
      'calendarOccupancyLegend':
          'To\'q = to\'liq band · Bo\'sh = ochiq vaqt',
      'unsavedChangesMessage':
          'Saqlanmagan o\'zgarishlar bor. Bekor qilinsinmi?',
      'pleaseChoosePlace': 'Iltimos, joy tanlang',
      'noSummaryYet': 'Saqlangan uchrashuv hujjati topilmadi.',
      'copied': 'Nusxa olindi',
      'noPrescriptions': 'Hali retseptlar yo\'q',
      'refreshing': 'Yangilanmoqda...',
      'selectPatientHint': 'Tafsilotlarni ko\'rish uchun bemorni tanlang',
      'filterConversations': 'Suhbatlarni filtrlash',
      'cannotOpenLink': 'Havolani ochib bo\'lmadi',
      'setUpClinicWorkspace':
          'Davolash rejalari yaratish uchun klinika ish maydonini sozlang.',
      'searchPatientsAppointmentsHint':
          'Bemorlar, uchrashuvlarni qidirish…',
      'confirmed': 'Tasdiqlangan',
      'inProgress': 'Jarayonda',
      'appointmentNotes': 'Uchrashuv yozuvlari',
      'summaryPdf': 'Xulosa PDF',
      'nextPatient': 'Keyingi bemor',
      'metricToday': 'Bugun',
      ...
      'hideAiReminders': 'Eslatmalarni yashirish',
      'showAiReminders': 'Eslatmalarni ko\'rsatish ({count})',
      'holdToExpandAnswer': 'Javobni kattalashtirish uchun bosib turing',
      'holdToCollapseAnswer': 'Javobni yig\'ish uchun bosib turing',
      'setPracticeTimezoneHint':
    ...
    'ru': {
      ...
      'clinicFinanceExport': 'Экспорт',
      'clinicFinanceExportCsv': 'Экспорт CSV',
      'clinicFinanceExportPdf': 'Экспорт PDF',
      'clinicFinanceExportFailed': 'Не удалось экспортировать',
      'clinicFinanceExportNoRows': 'По текущим фильтрам нечего экспортировать.',
      'clinicFinanceLoadMore': 'Загрузить ещё',
      'clinicFinanceShowingRows': 'Показано {{shown}} из {{total}}',
      'clinicFinanceTotalRevenueHint': 'Собранный доход по оплачиваемым визитам',
      'clinicFinanceInstallTotalsFilteredNote': 'Итоги соответствуют текущим фильтрам.',
      'clinicTreatmentPlanDetailTitle': 'План лечения',
      'clinicTreatmentPlanDetailNotFound': 'План лечения не найден.',
      'clinicTreatmentPlanDetailDentalChart': 'Зубная схема',
      'clinicTreatmentPlanLineStatus': 'Статус строки',
      'clinicTreatmentPlanLineStatusPlanned': 'Запланировано',
      'clinicTreatmentPlanLineStatusScheduled': 'Назначено',
      'clinicTreatmentPlansVisits': 'Визиты',
      'clinicTreatmentPlansVisitsLoading': 'Загрузка визитов…',
      'clinicTreatmentPlansNoVisits': 'К этому плану пока нет визитов.',
      'clinicTreatmentPlansNoVisitsShort': 'Нет визитов',
      'clinicTreatmentPlansOpenVisit': 'Открыть визит',
      'clinicTreatmentPlansVisitCancelled': 'Отменён',
      'clinicTreatmentPlansVisitCancelledOpen': 'Этот визит отменён.',
      'clinicTreatmentPlansVisitCount': '{{count}} визитов',
      'clinicTreatmentPlansVisitLabel': 'Визит',
      'clinicTreatmentPlansVisitPast': 'Прошедший',
      'clinicTreatmentPlansVisitUpcoming': 'Предстоящий',
      'clinicChangeStatus': 'Изменить статус',
      ...
      'notificationTypeAppointmentBooked': 'Запись создана',
      'notificationTypeAppointmentCancelled': 'Запись отменена',
      'notificationTypeAppointmentRescheduled': 'Запись перенесена',
      'notificationTypeAppointmentPaid': 'Оплата получена',
      'notificationTypePartnershipInvite': 'Приглашение в партнёрство',
      'notificationTypePartnershipAccepted': 'Партнёр принял приглашение',
      'notificationTypePartnershipProgress': 'Обновление партнёрства',
      'notificationTypeChatMessage': 'Новое сообщение',
      ...
      'inviteSentWaiting':
          'Приглашение отправлено. Ожидаем ответ от {name}.',
      'inviteReceivedFrom':
          '{name} пригласил(а) вас совместно вести этого пациента.',
      'cancelPartnerInvite': 'Отменить приглашение',
      'partnershipRoleSender': 'Вы отправили',
      'partnershipRoleInvitee': 'Приглашение вам',
      ...
      'more': 'Ещё',
      'calendarTimezoneMismatchHint':
          'Текущий часовой пояс устройства не совпадает с часовым поясом расписания ({scheduleTimeZone}). '
          'Слоты были заданы в одном часовом поясе, а сейчас вы в другом. '
          'Пожалуйста, учитывайте это при работе с приёмами.',
      'calendarStaffCalendars': 'Календари сотрудников',
      'calendarDayViewCount': 'Дней в сетке',
      'calendarOccupancyLegend':
          'Тёмный = занято · Без заливки = свободно',
      'unsavedChangesMessage':
          'Есть несохранённые изменения. Отменить их?',
      'pleaseChoosePlace': 'Пожалуйста, выберите место',
      'noSummaryYet': 'Сохранённая документация приёма не найдена.',
      'copied': 'Скопировано',
      'noPrescriptions': 'Рецептов пока нет',
      'refreshing': 'Обновление...',
      'selectPatientHint': 'Выберите пациента, чтобы увидеть детали',
      'filterConversations': 'Фильтр переписки',
      'cannotOpenLink': 'Не удалось открыть ссылку',
      'setUpClinicWorkspace':
          'Настройте рабочее пространство клиники, чтобы создавать планы лечения.',
      'searchPatientsAppointmentsHint':
          'Поиск пациентов, записей…',
      'confirmed': 'Подтверждено',
      'inProgress': 'В процессе',
      'appointmentNotes': 'Записи приёма',
      'summaryPdf': 'PDF сводка',
      ...
      'hideAiReminders': 'Скрыть напоминания',
      'showAiReminders': 'Показать напоминания ({count})',
      'holdToExpandAnswer': 'Удерживайте, чтобы увеличить ответ',
      'holdToCollapseAnswer': 'Удерживайте, чтобы свернуть ответ',
      'setPracticeTimezoneHint':
