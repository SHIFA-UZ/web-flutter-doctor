...
class EmailResetPasswordScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EmailResetPasswordScreen> createState() => _EmailResetPasswordScreenState();
}

class _EmailResetPasswordScreenState extends ConsumerState<EmailResetPasswordScreen> {
